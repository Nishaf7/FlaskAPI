...
import PyMysqlPool.mysql.connector.conversion
from mysql.connector import CharacterSet, FieldFlag, FieldType
from mysql.connector.custom_types import *
from PyMysqlPool.mysql.connector.catch23 import *


class FuzzyPoolMySQLConverter(object):
...
class FuzzyMySQLConverter(PyMysqlPool.mysql.connector.conversion.MySQLConverter, FuzzyPoolMySQLConverter):
    ...
    def __init__(self, charset=None, use_unicode=True):
        FuzzyPoolMySQLConverter.__init__(self, charset, use_unicode)
        self._cache_field_types = {}
