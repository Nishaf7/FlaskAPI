...
from PyMysqlPool.mysql.connector.django.introspection import \
...
try:
    ...
    from PyMysqlPool.mysql.connector.conversion import MySQLConverter, MySQLConverterBase
...
NotSupportedError = PyMysqlPool.mysql.connector.NotSupportedError
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_connection_params(self):
        ...
        kwargs['client_flags'] = [
            ...
            PyMysqlPool.mysql.connector.constants.ClientFlag.FOUND_ROWS,
        ]
        try:
    ...
    def mysql_version(self):
        ...
        temp_conn = PyMysqlPool.mysql.connector.connect(**config)
